...
const Main = (props) => {
    ...
    const [calendarStyles, setCalendarStyles] = useState(calStyles)
    ...
    const calendarStylesHandler = (stylesObj) => {
        setUpdateStyles(true)
        setCalendarStyles(stylesObj)
    }

    const clickHandler = (events, date) => {
            ...
            <div className={styles.demoContainer}>
                ...
                <div className={styles.detailsContainer}>
                    <div className={styles.detailsSection} >
                        ...
                        <p>Display your events in this simple, easy-to-use calendar events-viewer for React.</p>
                    </div>
